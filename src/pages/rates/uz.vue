...
store.fetchBank ({bank: 'uzBanks'}).then (response => {
  ...
  <div>
    ...
    >
      ...
      >
        <VAvatar
          size="50"
          image="/src/assets/images/misc/currencies/fiat/UZS.png"
        />
        Основные курсы валют Узбекистана
      </VCardText>
      <template
      ...
      >
        ...
        >
          Обмен {{currency.name}} в Узбекистане
        </VCardText>
