...
store.fetchBank ({bank: 'uaBanks'}).then (response => {
  ...
  <div>
    ...
    >
      ...
      >
        <VAvatar
          size="50"
          image="/src/assets/images/misc/currencies/fiat/UAH.png"
        />
        Основные курсы валют Украины
      </VCardText>
      <template
